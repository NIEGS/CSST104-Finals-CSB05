...
<head>
  ...
  <title>My GitHub Pages Template</title>
  <style>
...
<body>
  ...
  <header>
    <h1>Welcome to My GitHub Pages Template</h1>
  </header>

  <div class="container">
    <div class="content">
      <h2>About</h2>
      <p>This is a simple template for creating a website on GitHub Pages.</p>
      ...
      <h2>Get Started</h2>
      <p>To get started, fork or clone this repository and customize it to your liking.</p>
    </div>
  </div>
